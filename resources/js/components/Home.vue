    ...
    <div v-else>
        <div id="header">
                ...
                <div class="col" style="transform: translateX(-12%)">
                    <div class="row">
                        ...
                        <div class="col" style="margin-left: 0px; padding-left: 20px;padding-top: 2%;">
                            <h1 style="font-size:32px">Roommate.vn</h1>
                            <h5 style="font-size:16px">Web kiếm phòng trọ số 1 VN</h5>
                        </div>
                    </div>
                </div>
                <div class="col"></div>
            ...
            <div class="row filter-area">
                ...
                <div class="col">
                    <select class="form-select" v-model="checkDistrict">. <option>Quận/Huyện</option>
                ...
                <div class="col">
                    <select class="form-select" v-model="checkWard">. <option>Phường/Xã</option>
...
fetch("https://raw.githubusercontent.com/kenzouno1/DiaGioiHanhChinhVN/master/data.json").then(response => response.text()).then(text => JSON.parse(text)).then(data => (cities.value = data)).catch(error => {
    alert('error');
});
